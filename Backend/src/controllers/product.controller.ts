...
export const productController = {
  ...
  async update(req: Request, res: Response) {
    ...
    const cleaned = Object.fromEntries(Object.entries(payload).filter(([, v]) => v !== undefined)) as typeof payload
    const id = String(req.params.id)
    const product = await productService.update(id, cleaned as any)
