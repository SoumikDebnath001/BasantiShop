...
const DEFAULTS = {
  ...
  heroSubtext:
    'We are a local variety store. Create an account to explore our catalog of products.',
  heroCta: 'Shop Now',
  announcementBanner: null,
  announcementEnabled: false,
  aboutTitle: 'About Basanti',
  aboutText:
    'Basanti Variety Store brings together everyday essentials and specialty finds in one place. We focus on clear pricing, honest stock levels, and helping you complete your purchase.',
} as const
